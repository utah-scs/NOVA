...
def plot_rtt(df):
    ...
    df_new.plot(x='time', y='rtt_dpu', ax=ax, kind='line', marker='x', color='red', label='RTT DPU')
    df_new.plot(x='time', y='rtt_host', ax=ax, kind='line', marker='x', color='blue', label='RTT Host')
    ...
    ax.set_yticks([1, 10, 100, 500, 1000, 10000, 1500, 20000, 30000, 50000])
