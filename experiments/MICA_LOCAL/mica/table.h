...
// static
// uint32_t
// mehcached_calc_bucket_index(uint64_t key_hash);
...
// static
// bool
// mehcached_get(uint8_t current_alloc_id, struct mehcached_table *table, uint64_t key_hash, const uint8_t *key, size_t key_length, uint8_t *out_value, size_t *in_out_value_length);
